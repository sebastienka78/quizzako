...
/**
 * ResponseWordFragment
 * Template for response of type WORD
 *
 * Created by sebastienk on 21-Feb-16.
 */
@EFragment(R.layout.fragment_word_response)
public class ResponseWordFragment extends Fragment implements ResponseFragment {
